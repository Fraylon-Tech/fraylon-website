...
const NewsMedia = () => {
    return (
        <div className="page-news section" style={{ paddingTop: '120px', paddingBottom: '100px', background: 'var(--bg-surface)' }}>
            <div className="container ">
                <div style={{ textAlign: 'center', marginBottom: '60px' }}>
                    <h1 className="section-title">News & Insights</h1>
                    <p style={{ color: 'var(--text-secondary)', fontSize: '1.2rem' }}>
                        Latest updates, press releases, and thought leadership from Fraylon.
                    </p>
                </div>
                ...
                <div className="grid grid-3">
                    {articles.map((item, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            style={{ background: 'var(--bg-body)', borderRadius: '12px', overflow: 'hidden', cursor: 'pointer', transition: 'box-shadow 0.3s' }}
                        ...
                        >
                            ...
                            <div style={{ padding: '30px' }}>
                                ...
                                <h3 style={{ margin: '15px 0', fontSize: '1.4rem', color: 'var(--text-main)' }}>
                                    {item.title}
                                </h3>
